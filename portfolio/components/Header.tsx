...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="header">
        <div className="header-container">
          <a href="/index.html" className="logo">
            <img src="/assets/images/logo.svg" alt="Crennect Logo" />
          </a>
          
          <nav className="nav">
            <a href="/about.html">About us</a>
            <a href="https://www.behance.net/madebyprasad">Our work</a>
            <a href="/index.html#genai">GenAI</a>
            <a href="/services.html">How We Help</a>
            <a href="/index.html#resources">Resources</a>
            <a href="https://linktr.ee/crennect" className="btn-nav">Breaking Brands</a>
          </nav>
      ...
      {/* Mobile Menu - exact copy from homepage */}
      <div className={`mobile-menu ${mobileMenuOpen ? 'active' : ''}`}>
        ...
        <div className="mobile-menu-content">
          ...
          <div className="mobile-menu-links">
            ...
            <a href="https://www.behance.net/madebyprasad" onClick={closeMobileMenu}>Our work</a>
